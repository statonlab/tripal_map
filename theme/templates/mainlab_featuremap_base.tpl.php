...
foreach ( $organisms as $org ) {
  ...
  $link = tripal_map_mainlab_tripal_link_record('organism', $organism->organism_id);
  if ($link) {
...
if ($maternal) {
  $mlink = tripal_map_mainlab_tripal_link_record('stock', $maternal->stock_id);
  if ($mlink) {
...
if ($paternal) {
  $plink = tripal_map_mainlab_tripal_link_record('stock', $paternal->stock_id);
  if ($plink) {
...
// print the MapViewer glyphs
$tripal_map_genetic_map_overview_form = $variables['tripal_map_genetic_map_overview_form'];
print drupal_render($tripal_map_genetic_map_overview_form);
